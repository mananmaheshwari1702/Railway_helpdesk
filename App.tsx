    ...
    **CONVERSATION STYLE**:
    ...
    const connectToGemini = async (isRetry = false) => {
        ...
        try {
            ...
            // --- AUDIO WORKLET SETUP ---
            // Replaces deprecated ScriptProcessorNode for stability on maintenance thread
            try {
            ...
            // Handle Audio Chunks from Worklet (Runs independently of Main UI Thread)
            workletNode.port.onmessage = (event) => {
                ...
                // Send to Gemini
                // Data is already 16k from Worklet
            ...
            // Connect: Source -> HighPass -> MudCut -> SpeechBoost -> Compressor -> Worklet -> Dest
            ...
            const sessionPromise = ai.live.connect({
                ...
                callbacks: {
                    onopen: () => {
                        ...
                        // Audio processing is now handled via AudioWorklet port listeners set up above
                    },
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            <header className="bg-blue-900 text-white p-4 shadow-lg flex items-center justify-between z-10">
                ...
                <div className="flex items-center space-x-4">
                    <div className={`px-4 py-1 rounded-full border ${status === ConnectionStatus.CONNECTED ? 'bg-green-600 border-green-400' :
                        ...
                        {status === ConnectionStatus.DISCONNECTED || status === ConnectionStatus.ERROR ? (
                            <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                        {LANGUAGES.map((lang) => (
                                            <button
                                                ...
                                                className={`p-2 rounded-lg border-2 text-left transition-all ${selectedLanguage === lang.id
                                ...
                                <button
                                    ...
                                    className={`w-full py-4 rounded-lg font-bold text-lg shadow-lg transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3 ${status === ConnectionStatus.ERROR
